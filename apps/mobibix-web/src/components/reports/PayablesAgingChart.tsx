...
import { getPayablesAging, type AgingReport } from "@/services/reports.api";

export function PayablesAgingChart() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-lg bg-linear-to-br from-red-50 to-red-100 border border-red-200 p-6">
              ...
              <div key={bucket.bucket} className="space-y-2">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-gray-900 font-semibold">
                    ₹{bucket.amount.toLocaleString()} ({bucket.count} purchases)
                  </span>
                </div>
