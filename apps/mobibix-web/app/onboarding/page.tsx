        ...
        <form onSubmit={handleCreateBusiness} className="mt-6 space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg border border-white/10 bg-black px-3 py-2 text-sm text-white placeholder:text-stone-500 focus:border-blue-400 focus:outline-none"
            />
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="mt-2 flex w-full items-center justify-center gap-2 rounded-lg bg-blue-500 px-4 py-2 text-sm font-medium text-black transition hover:bg-blue-400 disabled:opacity-50"
          >
