...
> = {
  ...
  [WhatsAppModule.DIGITAL_LEDGER]: {
    GLOBAL: {
      businessName: {
        key: 'businessName',
        label: 'Business Name',
        module: WhatsAppModule.DIGITAL_LEDGER,
        sourceType: VariableSourceType.ENTITY,
        sourcePath: 'Tenant.name',
        dataType: VariableDataType.STRING,
        required: true,
    ...
    PAYMENT_DUE: {
      customerName: {
        ...
        module: WhatsAppModule.DIGITAL_LEDGER,
        sourceType: VariableSourceType.ENTITY,
        sourcePath: 'LedgerCustomer.name',
        dataType: VariableDataType.STRING,
        required: true,
      },
      amountDue: {
        ...
        module: WhatsAppModule.DIGITAL_LEDGER,
        sourceType: VariableSourceType.ENTITY,
        sourcePath: 'LedgerCollection.amount',
        dataType: VariableDataType.CURRENCY,
        required: true,
      },
      dueDate: {
        ...
        module: WhatsAppModule.DIGITAL_LEDGER,
        sourceType: VariableSourceType.ENTITY,
        sourcePath: 'LedgerCollection.dueDate',
        dataType: VariableDataType.DATE,
        required: true,
      },
      installmentNo: {
        ...
        module: WhatsAppModule.DIGITAL_LEDGER,
        sourceType: VariableSourceType.ENTITY,
        sourcePath: 'LedgerCollection.periodNo',
        dataType: VariableDataType.NUMBER,
        required: false,
      },
    },
