...
export const SubscriptionActivatedEmail = ({
  ...
  return (
    <EmailLayout
      module={module}
      preview="AutoPay is active — you’re all set ✅"
    >
      <EmailSection>
        <Text
        ...
        <Text style={{ color: '#4b5563', lineHeight: '24px' }}>
          Your AutoPay subscription for <strong>{planName}</strong> is now
        ...
        <Text style={{ color: '#4b5563', lineHeight: '24px' }}>
          You don’t need to worry about renewals anymore — everything is handled
          automatically.
        </Text>
        <Text style={{ color: '#4b5563', lineHeight: '24px' }}>
