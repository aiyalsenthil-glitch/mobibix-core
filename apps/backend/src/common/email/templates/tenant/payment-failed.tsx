...
export const PaymentFailedEmail = ({ 
  ...
  const buttonText = isFinalWarning ? 'Resolve Payment Now' : 'Update Payment Details';
    ...
    <EmailLayout module={module} preview={subject}>
      <EmailSection>
        ...
        {!isFinalWarning ? (
          <>
            <Text style={{ fontSize: '16px', color: '#4b5563', lineHeight: '24px' }}>
              We attempted to process your recent payment for <strong>{planName}</strong>, but it didn’t go through.
            </Text>
            <Text style={{ fontSize: '16px', color: '#4b5563', lineHeight: '24px' }}>
              This usually happens due to:<br />
              • Bank authorization issue<br />
          ...
          <>
            <Text style={{ fontSize: '16px', color: '#4b5563', lineHeight: '24px' }}>
              We’ve attempted multiple times to process your payment, but it’s still pending.
            </Text>
            <Text style={{ fontSize: '16px', color: '#4b5563', lineHeight: '24px' }}>
              To prevent temporary suspension of your account, please update your payment details immediately.
            </Text>
          </>
        )}
        ...
        {!isFinalWarning ? (
          <Text style={{ fontSize: '16px', color: '#4b5563', lineHeight: '24px', marginTop: '24px' }}>
            Your access remains active for now — but we recommend resolving this today.
            <br /><br />
