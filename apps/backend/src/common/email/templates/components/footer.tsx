...
export const EmailFooter = ({ module }: EmailFooterProps) => {
  ...
  const website = module === 'MOBILE_SHOP' ? 'https://mobibix.com' : 'https://mobibix.in';
  ...
  return (
    <Section style={{ marginTop: '48px' }}>
      ...
      <Text style={{ color: '#8898aa', fontSize: '12px', lineHeight: '16px' }}>
        ...
        <br />
        <Link href={website} style={{ color: '#8898aa', textDecoration: 'underline' }}>
          {website.replace('https://', '')}
        </Link>
      </Text>
      <Text style={{ color: '#8898aa', fontSize: '12px', lineHeight: '16px', marginTop: '12px' }}>
