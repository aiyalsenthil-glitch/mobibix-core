import { Img, Section, Row, Column, Link, Button } from '@react-email/components';
...
export const EmailHeader = ({ module, showDashboardButton }: EmailHeaderProps) => {
  const config = BRAND[module] || BRAND.GYM;

  return (
    <Section style={{ backgroundColor: '#ffffff', padding: '20px 24px', borderBottom: `4px solid ${config.primaryColor}` }}>
      <Row>
        <Column align="left">
          ...
          <Section style={{ marginTop: '4px' }}>
            <span style={{ fontSize: '10px', color: '#6B7280', fontFamily: 'sans-serif', letterSpacing: '0.05em', textTransform: 'uppercase' }}>
              {config.tagline}
            </span>
          </Section>
        </Column>
