...
-- CreateEnum
CREATE TYPE "WhatsAppFeature" AS ENUM ('STAFF', 'ATTENDANCE', 'REPORTS', 'CUSTOM_PRINT_LAYOUT', 'MULTI_SHOP', 'WHATSAPP_UTILITY', 'WHATSAPP_MARKETING', 'WHATSAPP_ALERTS_AUTOMATION');

-- CreateEnum
CREATE TYPE "WhatsAppCampaignStatus" AS ENUM ('DRAFT', 'SCHEDULED', 'RUNNING', 'COMPLETED', 'FAILED');

-- CreateEnum
CREATE TYPE "FinanceType" AS ENUM ('IN', 'OUT');

-- CreateEnum
CREATE TYPE "FinanceRefType" AS ENUM ('INVOICE', 'PURCHASE', 'EXPENSE', 'SALARY', 'JOBCARD', 'JOB', 'JOBCARD_ADVANCE', 'DEBT_COLLECTION', 'ADJUSTMENT', 'RECEIPT');

-- CreateEnum
CREATE TYPE "JobStatus" AS ENUM ('RECEIVED', 'ASSIGNED', 'DIAGNOSING', 'WAITING_APPROVAL', 'APPROVED', 'WAITING_FOR_PARTS', 'IN_PROGRESS', 'READY', 'DELIVERED', 'CANCELLED', 'RETURNED');
...
-- CreateEnum
CREATE TYPE "ReceiptType" AS ENUM ('CUSTOMER', 'GENERAL', 'ADJUSTMENT', 'PAYMENT', 'JOB_ADVANCE');
...
-- CreateEnum
CREATE TYPE "VoucherSubType" AS ENUM ('ADVANCE', 'SETTLEMENT');
...
-- CreateEnum
CREATE TYPE "DocumentType" AS ENUM ('SALES_INVOICE', 'PURCHASE_INVOICE', 'JOB_CARD', 'RECEIPT', 'QUOTATION', 'PURCHASE_ORDER', 'PAYMENT_VOUCHER', 'REPAIR_INVOICE');

-- CreateEnum
CREATE TYPE "InvoiceType" AS ENUM ('SALES', 'REPAIR');

-- CreateEnum
CREATE TYPE "RepairInvoiceNumberingMode" AS ENUM ('SHARED', 'SEPARATE');
...
-- CreateEnum
CREATE TYPE "ModuleType" AS ENUM ('GYM', 'MOBILE_SHOP', 'MOBILE_REPAIR', 'WHATSAPP_CRM');

-- CreateEnum
CREATE TYPE "ReminderTriggerType" AS ENUM ('DATE', 'AFTER_INVOICE', 'AFTER_JOB', 'EVENT_BASED');
...
CREATE TABLE "Tenant" (
    ...
    "whatsappCrmEnabled" BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE "Plan" (
    ...
    "maxMembers" INTEGER,
    "maxShops" INTEGER,
    "whatsappUtilityQuota" INTEGER NOT NULL DEFAULT 0,
    "whatsappMarketingQuota" INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE "TenantSubscription" (
    ...
    "tenantId" TEXT NOT NULL,
    "planId" TEXT NOT NULL,
    "module" "ModuleType" NOT NULL DEFAULT 'MOBILE_SHOP',
...
-- CreateTable
CREATE TABLE "WhatsAppDailyUsage" (
    "id" TEXT NOT NULL,
    "tenantId" TEXT NOT NULL,
    "date" DATE NOT NULL,
    ...
    CONSTRAINT "WhatsAppDailyUsage_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "UsageSnapshot" (
    ...
    "activeShops" INTEGER NOT NULL DEFAULT 0,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "Shop" (
    ...
    "repairInvoiceNumberingMode" "RepairInvoiceNumberingMode" NOT NULL DEFAULT 'SHARED',
    "repairGstDefault" BOOLEAN NOT NULL DEFAULT false,
    "bankName" TEXT,
    "accountNumber" TEXT,
    "ifscCode" TEXT,
    "branchName" TEXT,
...
CREATE TABLE "InvoiceItem" (
    ...
    "gstAmount" INTEGER NOT NULL,
    "cgstRate" DECIMAL(65,30) NOT NULL DEFAULT 9.0,
    "sgstRate" DECIMAL(65,30) NOT NULL DEFAULT 9.0,
    "igstRate" DECIMAL(65,30) NOT NULL DEFAULT 0.0,
    "cgstAmount" INTEGER,
    "sgstAmount" INTEGER,
    "igstAmount" INTEGER,
...
CREATE TABLE "Purchase" (
    ...
    "isLegacyGstApproximation" BOOLEAN NOT NULL DEFAULT false,
    "gstApproximationReason" TEXT,
...
CREATE TABLE "AdvanceApplication" (
    "id" TEXT NOT NULL,
    "advanceVoucherId" TEXT NOT NULL,
    "purchaseId" TEXT NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "Party_tenantId_phone_key" ON "Party"("tenantId", "phone");
...
-- CreateIndex
CREATE INDEX "TenantSubscription_module_idx" ON "TenantSubscription"("module");

-- CreateIndex
CREATE INDEX "TenantSubscription_autoRenew_idx" ON "TenantSubscription"("autoRenew");

-- CreateIndex
CREATE UNIQUE INDEX "TenantSubscription_tenantId_module_key" ON "TenantSubscription"("tenantId", "module");

-- CreateIndex
CREATE INDEX "SubscriptionAddon_subscriptionId_idx" ON "SubscriptionAddon"("subscriptionId");

-- CreateIndex
CREATE INDEX "SubscriptionAddon_addonPlanId_idx" ON "SubscriptionAddon"("addonPlanId");

-- CreateIndex
CREATE UNIQUE INDEX "SubscriptionAddon_subscriptionId_addonPlanId_key" ON "SubscriptionAddon"("subscriptionId", "addonPlanId");
...
-- CreateIndex
CREATE INDEX "WhatsAppDailyUsage_tenantId_idx" ON "WhatsAppDailyUsage"("tenantId");

-- CreateIndex
CREATE INDEX "WhatsAppDailyUsage_date_idx" ON "WhatsAppDailyUsage"("date");

-- CreateIndex
CREATE UNIQUE INDEX "WhatsAppDailyUsage_tenantId_date_key" ON "WhatsAppDailyUsage"("tenantId", "date");

-- CreateIndex
CREATE INDEX "UsageSnapshot_date_idx" ON "UsageSnapshot"("date");

-- CreateIndex
CREATE UNIQUE INDEX "UsageSnapshot_tenantId_date_key" ON "UsageSnapshot"("tenantId", "date");
...
-- CreateIndex
CREATE INDEX "JobCardPart_shopProductId_idx" ON "JobCardPart"("shopProductId");

-- CreateIndex
CREATE UNIQUE INDEX "JobCardPart_jobCardId_shopProductId_key" ON "JobCardPart"("jobCardId", "shopProductId");
...
-- CreateIndex
CREATE INDEX "Receipt_linkedJobCardId_idx" ON "Receipt"("linkedJobCardId");
...
-- CreateIndex
CREATE INDEX "AdvanceApplication_advanceVoucherId_idx" ON "AdvanceApplication"("advanceVoucherId");

-- CreateIndex
CREATE INDEX "AdvanceApplication_purchaseId_idx" ON "AdvanceApplication"("purchaseId");

-- CreateIndex
CREATE UNIQUE INDEX "AdvanceApplication_advanceVoucherId_purchaseId_key" ON "AdvanceApplication"("advanceVoucherId", "purchaseId");
...
-- AddForeignKey
ALTER TABLE "Member" ADD CONSTRAINT "Member_customerId_fkey" FOREIGN KEY ("customerId") REFERENCES "Party"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "CustomerFollowUp" ADD CONSTRAINT "CustomerFollowUp_customerId_fkey" FOREIGN KEY ("customerId") REFERENCES "Party"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "CustomerReminder" ADD CONSTRAINT "CustomerReminder_customerId_fkey" FOREIGN KEY ("customerId") REFERENCES "Party"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "LoyaltyTransaction" ADD CONSTRAINT "LoyaltyTransaction_customerId_fkey" FOREIGN KEY ("customerId") REFERENCES "Party"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "CustomerAlert" ADD CONSTRAINT "CustomerAlert_customerId_fkey" FOREIGN KEY ("customerId") REFERENCES "Party"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "SubscriptionAddon" ADD CONSTRAINT "SubscriptionAddon_addonPlanId_fkey" FOREIGN KEY ("addonPlanId") REFERENCES "Plan"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "WhatsAppLog" ADD CONSTRAINT "WhatsAppLog_customerId_fkey" FOREIGN KEY ("customerId") REFERENCES "Party"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "WhatsAppDailyUsage" ADD CONSTRAINT "WhatsAppDailyUsage_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "WhatsAppCampaign" ADD CONSTRAINT "WhatsAppCampaign_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "JobCardPart" ADD CONSTRAINT "JobCardPart_shopProductId_fkey" FOREIGN KEY ("shopProductId") REFERENCES "ShopProduct"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Purchase" ADD CONSTRAINT "Purchase_globalSupplierId_fkey" FOREIGN KEY ("globalSupplierId") REFERENCES "Party"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "SupplierPayment" ADD CONSTRAINT "SupplierPayment_globalSupplierId_fkey" FOREIGN KEY ("globalSupplierId") REFERENCES "Party"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Receipt" ADD CONSTRAINT "Receipt_customerId_fkey" FOREIGN KEY ("customerId") REFERENCES "Party"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Receipt" ADD CONSTRAINT "Receipt_linkedJobCardId_fkey" FOREIGN KEY ("linkedJobCardId") REFERENCES "JobCard"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "PaymentVoucher" ADD CONSTRAINT "PaymentVoucher_globalSupplierId_fkey" FOREIGN KEY ("globalSupplierId") REFERENCES "Party"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "AdvanceApplication" ADD CONSTRAINT "AdvanceApplication_advanceVoucherId_fkey" FOREIGN KEY ("advanceVoucherId") REFERENCES "PaymentVoucher"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "AdvanceApplication" ADD CONSTRAINT "AdvanceApplication_purchaseId_fkey" FOREIGN KEY ("purchaseId") REFERENCES "Purchase"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "PurchaseOrder" ADD CONSTRAINT "PurchaseOrder_globalSupplierId_fkey" FOREIGN KEY ("globalSupplierId") REFERENCES "Party"("id") ON DELETE SET NULL ON UPDATE CASCADE;
