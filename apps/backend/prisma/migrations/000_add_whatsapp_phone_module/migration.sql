...
-- CreateEnum
CREATE TYPE "InvoiceStatus" AS ENUM ('PAID', 'CANCELLED', 'CREDIT');
...
CREATE TABLE "Tenant" (
    ...
    "website" TEXT,
    "logoUrl" TEXT,
    -- Minimal migration: create module-scoped WhatsApp phone numbers table only.
    BEGIN;
...
-- CreateIndex
CREATE INDEX "WhatsAppAutomation_moduleType_triggerType_idx" ON "WhatsAppAutomation"("moduleType", "triggerType");
