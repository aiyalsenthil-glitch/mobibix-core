...
async function main() {
  ...
  console.log(
    `Found ${tenants.length} tenants and ${modules.length} module defaults`,
  );
  ...
  console.log(
    `Seeding complete. Created ~${totalCreated}. Tenants skipped (already had numbers): ${tenantsSkipped}`,
  );
}
